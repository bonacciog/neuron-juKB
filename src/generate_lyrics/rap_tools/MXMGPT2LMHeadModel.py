...
class MXMGPT2LMHeadModel(GPT2LMHeadModel):
    ...
    def generate(
        ...
        print("sei nella generate di MXM con rhyming")
    ...
    def _generate_no_beam_search(
        ...
        while cur_len < max_length:
            ...
            if do_sample:
                ...
                #logits_norm_df["RL"] = logits_norm_df["Class"].apply(lambda x: get_candidate_score(x, lyric_sofar))
                ...
                print(candidates_probs)
                rhyming_lengths = get_candidate_scores()
...
if __name__ == "__main__":
    ...
    model = MXMGPT2LMHeadModel.from_pretrained("gpt2")
